...
module RTP
  ...
  describe "RTP#leaf_boundaries" do
    ...
    it "should give the expected positions for a 58 leaf MLC (29 leaves on one side)" do
    ...
    it "should give the expected positions for a 80 leaf MLC (40 leaves on one side)" do
    ...
    it "should give the expected positions for a 81 leaf MLC (41 leaves on one side)" do
      # Example models: Siemens Oncor 81 leaf
